//
//  TJLaunchAnimateViewController.m
//  bubble
//
...
static const CGFloat kDefaultWaitDuration = 2.0;

@interface TJLaunchAnimateViewController () <CAAnimationDelegate>
...
@implementation TJLaunchAnimateViewController

#pragma mark - lazy load
- (DSSkipButton *)skipButton{
    if (!_skipButton) {
        _skipButton = [DSSkipButton new];
